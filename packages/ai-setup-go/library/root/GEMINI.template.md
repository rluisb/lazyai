...
<!-- Example: @specs/rules/typescript-rules.md -->
...
|-------------|--------------|
| New module or directory | Root GEMINI.md (codebase map) + @specs/KNOWLEDGE_MAP.md |
...
| Refactor changed structure | Root GEMINI.md + @specs/standards/ + @specs/KNOWLEDGE_MAP.md |
