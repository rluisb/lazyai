...
func neutralContractFS() fstest.MapFS {
	return fstest.MapFS{
		...
		"canonical/skills/codebase-exploration.md":        &fstest.MapFile{Data: canonicalSkillFixture("codebase-exploration", "Codebase exploration skill.")},
		"canonical/skills/test-first-change.md":           &fstest.MapFile{Data: canonicalSkillFixture("test-first-change", "Test first change skill.")},
		"canonical/skills/diagnose.md":                    &fstest.MapFile{Data: canonicalSkillFixture("diagnose", "Diagnose skill.")},
		"canonical/skills/pr-review.md":                   &fstest.MapFile{Data: canonicalSkillFixture("pr-review", "PR review skill.")},
