// Package plugin generates a Claude Code plugin directory from LazyAI's
...
// Metadata about LazyAI as a Claude plugin. Hardcoded per spec 016 Q4.
const (
	PluginName        = "lazyai"
	PluginDescription = "LazyAI agents, skills, commands, and output styles for Claude Code"
	PluginAuthorName  = "Ricardo Borges"
	PluginAuthorURL   = "https://github.com/rluisb/lazyai/packages/cli"
	PluginHomepage    = "https://github.com/rluisb/lazyai/packages/cli"
	PluginRepository  = "https://github.com/rluisb/lazyai/packages/cli"
	PluginLicense     = "MIT"
)
...
func buildManifest(outDir, version string) error {
	...
	manifest := map[string]any{
		...
		"keywords":   []string{"lazyai", "lazyai-cli", "claude-code", "agents", "skills"},
	}
