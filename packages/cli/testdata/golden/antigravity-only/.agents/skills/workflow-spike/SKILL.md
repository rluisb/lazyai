---
name: spike
description: Use when the goal is to investigate, map constraints, and return evidence without committing to implementation. Uses write tools, shell execution, and may spawn subagents. Invoke with enable_write_tools=true and enable_subagent_tools=true.
status: draft
---
